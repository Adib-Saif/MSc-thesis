...
# Load strain data
strain_data_path = r"D:\MSc Thesis\Final PyPy\Data\LC 50.xlsx"
...
# Plotting with grids
plot_contour_with_grids(grid_x, grid_y, grid_z_xx, 'Strain Map_125KN (Horizontal)', 'strain_map_horizontal_50KN.png')
plot_contour_with_grids(grid_x, grid_y, grid_z_yy, 'Strain Map_125KN (Vertical)', 'strain_map_vertical_50KN.png')
plot_contour_with_grids(grid_x, grid_y, grid_z_xy, 'Strain Map_125KN (Diagonal)', 'strain_map_diagonal_50KN.png')
...
plot_map_with_grids(grid_x, grid_y, grid_Emax, 'Principal Strain (ε_max) , Applied Load 50KN ', 'ε_max [μɛ]',
                    'principal_strain_emax_50KN.png', cmap='plasma')

# Principal Strain (Emin): Diverging
plot_map_with_grids(grid_x, grid_y, grid_Emin, 'Principal Strain (ε_min) , Applied Load 50KN ', 'ε_min [μɛ]',
                    'principal_strain_emin_50KN.png', cmap='plasma', vmin=-150, vmax=50)

# Shear Strain (Ymax): Sequential
plot_map_with_grids(grid_x, grid_y, grid_Ymax, 'Shear Strain (γ_max) , Applied Load 50KN ', 'γ_max [μɛ]',
                    'shear_strain_ymax_50KN.png', cmap='plasma')
