...
# Interpolate strain data for 125 kN load level
interpolated_horizontal = interpolate_strain_with_extrapolation(horizontal_df, 'Strain 125', common_xi, common_yi)
interpolated_vertical = interpolate_strain_with_extrapolation(vertical_df, 'Strain 125', common_xi, common_yi)
interpolated_diagonal = interpolate_strain_with_extrapolation(diagonal_df, 'Strain 125', common_xi, common_yi)
...
plot_strain_map(common_xi, common_yi, e_max, 'Principal Strain (ε_max) , Applied Load 125 kN', 'principal_strain_emax_125KN.png')
plot_strain_map(common_xi, common_yi, e_min, 'Principal Strain (ε_min) , Applied Load 125 kN', 'principal_strain_emin_125KN.png')
plot_strain_map(common_xi, common_yi, gamma_max, 'Shear Strain (γ_max) , Applied Load 125 kN', 'shear_strain_gamma_max_125KN.png')
...
e_max_specific = interpolate_strain_with_extrapolation(horizontal_df, 'Strain 125', specific_x, specific_y)
e_min_specific = interpolate_strain_with_extrapolation(vertical_df, 'Strain 125', specific_x, specific_y)
gamma_max_specific = interpolate_strain_with_extrapolation(diagonal_df, 'Strain 125', specific_x, specific_y)
...
output_df.to_excel('strain_data_at_points_125KN.xlsx', index=False)
