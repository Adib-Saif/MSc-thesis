...
# Load  strain data
data_path = r"D:\MSc Thesis\Final PyPy\Data\LC 50.xlsx"
...
plot_interpolated(grid_x, grid_y, grid_strain_xx, "Interpolated Strain , Applied Load 50KN", "strain_xx_50KN.png")
plot_interpolated(grid_x, grid_y, grid_strain_yy, "Interpolated Strain , Applied Load 50KN", "strain_yy_50KN.png")
plot_interpolated(grid_x, grid_y, grid_strain_xy, "Interpolated Strain , Applied Load 50KN", "strain_xy_50KN.png")
...
plot_principal_map(grid_x, grid_y, epsilon_max, "Principal Strain (ε_max), Applied Load 50KN ", "principal_strain_epsilon_max_50KN.png")
plot_principal_map(grid_x, grid_y, epsilon_min, "Principal Strain (ε_min) , Applied Load 50KN ", "principal_strain_epsilon_min_50KN.png")
plot_principal_map(grid_x, grid_y, gamma_max, "Shear Strain (γ_max) , Applied Load 50KN ", "shear_strain_gamma_max_50KN.png")
...
# Save to Excel
output_file = "strain_data_at_specific_points.xlsx"
