...
# Load strain data
data_path = r"D:\MSc Thesis\Final PyPy\Data\LC 200.xlsx"
...
plot_interpolated(grid_x, grid_y, grid_strain_xx, "Interpolated Strain , Applied Load 200KN", "strain_xx_200KN.png")
plot_interpolated(grid_x, grid_y, grid_strain_yy, "Interpolated Strain ,  Applied Load 200KN", "strain_yy_200KN.png")
plot_interpolated(grid_x, grid_y, grid_strain_xy, "Interpolated Strain , Applied Load 200KN", "strain_xy_200.png")
...
plot_principal_map(grid_x, grid_y, epsilon_max, "Principal Strain (ε_max) , Applied Load 200KN", "principal_strain_epsilon_max_200KN.png")
plot_principal_map(grid_x, grid_y, epsilon_min, "Principal Strain (ε_min) , Applied Load 200KN", "principal_strain_epsilon_min_200KN.png")
plot_principal_map(grid_x, grid_y, gamma_max, "Shear Strain (γ_max) , Applied Load 200KN", "shear_strain_gamma_max_200KN.png")
...
# Save to Excel
output_file = "strain_data_at_specific_points_200KN.xlsx"
